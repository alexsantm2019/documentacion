...
<?php
$this->title = 'Documentos Disponibles';
?>
<div class ="row">
    <div class="col-lg-8">
...
echo GridView::widget([
    'id'=>'module',
    'dataProvider'=>$dataProvider_usuario,
...
//    'hover'=>true,
    ...
    'panel'=>['type'=>'primary', 'heading'=>'Documentos disponibles'],
    'columns'=>[
        ...
        [
           ...
           ['class' => 'kartik\grid\ActionColumn',
                    ...
                    [                           
                                ...
                                $codigo = $model['codigo'];
                                $query = app\models\Documento::find()->where(['codigo'=>$codigo])->count();
                                if($query >1){                                        
                                         return Html::a( '<i class="glyphicon glyphicon-list-alt " style="color:white"></i>',
                                                        ['documento/historial', 
                                                            'codigo'=>$model['codigo'],
                                                        ],
                                                        ['class'=>'btn btn-warning btn-md', 'title'=>'Historial' ]
                                                );
                                }
                        },
                    ],
