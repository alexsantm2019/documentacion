...
<div class="registro-sanitario-form">
    ...
    <div class="col-md-6"> <?= $form->field($model, 'codigo')->textInput(['maxlength' => true]) ?> </div>

    <div class="col-md-6"> <?= $form->field($model, 'producto')->textInput(['maxlength' => true]) ?> </div>
    ...
    <div class="col-md-6">
    <?php
    echo $form->field($model, 'fecha_vigencia')->widget(DatePicker::classname(), [
        'options' => ['placeholder' => 'Ingrese la fecha de Vigencia ...'],
        'pluginOptions' => [
                    'autoclose'=>true,
                    'format' => 'yyyy-mm-dd',
                    'todayHighlight' => true
